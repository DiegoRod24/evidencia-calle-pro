/* ONE SHOP v5.7.3 · CAMPO ESTABLE + HERRAMIENTAS LAZY */
(()=>{
'use strict';
if(window.ONE_SHOP_STABLE_RUNTIME)return;
const BUILD='one-shop-v5.7.3-field-essential-01';
...
function patchBoot(){
  ...
  try{if(typeof State!=='undefined'&&State.settings){if(localStorage.getItem('oneShopStablePrefs573')!=='1'||State.settings.nearbyHistoryEnabled!==false){State.settings.nearbyHistoryEnabled=false;localStorage.setItem('oneShopStablePrefs573','1');try{Store?.saveLite?.()}catch(_){}}}}catch(_){}
