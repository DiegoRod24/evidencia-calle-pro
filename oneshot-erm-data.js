...
(()=>{
'use strict';
const BUILD='one-shop-field-boot-20260828-02-v578';
...
async function boot(){
  ...
  try{
    await load('/one-shop-stable-runtime.js?v=20260828-02-v578','ONE_SHOP_STABLE_RUNTIME');
    await load('/one-shop-field-quality-v578.js?v=20260828-02-v578','ONE_SHOP_FIELD_QUALITY_V578');
    await load('/one-shop-storage-lite-v578.js?v=20260828-02-v578','ONE_SHOP_STORAGE_LITE_V578');
    await load('/one-field-report-standard.js?v=20260828-02-v8','ONE_FIELD_REPORT_STANDARD_V8');
