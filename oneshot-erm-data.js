...
(()=>{
'use strict';
const BUILD='one-shop-field-boot-20260828-03-v579';
...
async function boot(){
  ...
  try{
    await load('/one-shop-stable-runtime.js?v=20260828-03-v579','ONE_SHOP_STABLE_RUNTIME');
    await load('/one-shop-field-quality-v578.js?v=20260828-03-v579','ONE_SHOP_FIELD_QUALITY_V578');
    await load('/one-shop-excel-thumb-v579.js?v=20260828-03-v579','ONE_SHOP_EXCEL_THUMB_V579');
    await load('/one-shop-storage-lite-v578.js?v=20260828-03-v579','ONE_SHOP_STORAGE_LITE_V578');
    await load('/one-field-report-standard.js?v=20260828-03-v8','ONE_FIELD_REPORT_STANDARD_V8');
    ...
    try{window.ONE_SHOP_EXCEL_THUMB_V579?.patch?.()}catch(_){}
    console.info('[ONE SHOP] evidencia nativa + Excel suave activados',BUILD);
  }catch(e){console.warn('[ONE SHOP] no se pudo completar el arranque v5.7.9',e)}
}
